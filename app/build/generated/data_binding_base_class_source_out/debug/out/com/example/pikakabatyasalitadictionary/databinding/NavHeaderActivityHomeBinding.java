...
public final class NavHeaderActivityHomeBinding implements ViewBinding {
  ...
  private NavHeaderActivityHomeBinding(@NonNull LinearLayout rootView, @NonNull ImageView imageView,
  ...
  public static NavHeaderActivityHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavHeaderActivityHomeBinding((LinearLayout) rootView, imageView, textView);
    }
